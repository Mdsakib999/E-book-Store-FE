...
export const BookCard = ({ img, title, author, price }) => {
	return (
		<div className="w-full h-[400px] mx-auto overflow-hidden rounded-md group relative hover:shadow-2xl border border-gray-200 hover:border hover:border-gray-800 duration-300">
			...
			<div className="absolute bottom-0 z-10 w-full h-[35%] p-4 bg-white flex flex-col justify-between gap-4 transition-all duration-500 group-hover:translate-y-[-40px]">
				{/* Top Content */}
				<div>
				...
				<div className="opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 flex justify-between items-center">
					<button
						...
						className="cursor-pointer text-sm sm:text-md bg-black hover:bg-white hover:border hover:text-black duration-300 px-10 py-3 rounded text-white"
					>
						Add to cart
					</button>
