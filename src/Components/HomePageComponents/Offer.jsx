...
export const Offer = () => {
  return (
    <div className="rounded-lg relative w-full mt-[200px] md:mt-[300px] lg:mt-[200px] py-32 md:py-20 max-w-7xl mx-auto bg-gradient-to-b from-black to-gray-100">
      {/* Card Container */}
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 rounded bg-white/30 py-16">
        {/* Book Image */}
        <div className="absolute -top-5 md:right-20 md:-top-20 lg:-top-5 z-10 drop-shadow-xl">
        ...
        <div className="relative z-20 max-w-2xl lg:text-left">
          ...
          <p className="mt-4 text-lg leading-6 text-white drop-shadow-xl">
