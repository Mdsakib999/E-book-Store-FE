...
export const Offer = () => {
  return (
    <div className="rounded-lg relative w-full mt-[200px] md:mt-[300px] lg:mt-[200px] p-8 max-w-7xl mx-auto bg-black/40 backdrop-blur-md">
      {/* Aurora Effect */}
      <div className="absolute inset-0 rounded-lg bg-gradient-to-b from-black via-gray-800 to-black"></div>

      {/* Book Image Half Above the Card */}
      <div className="absolute -top-24 md:-top-30 lg:-top-5 md:right-0 md:-translate-y-1/3 md:z-10">
