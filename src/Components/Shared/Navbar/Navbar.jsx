			...
			<nav className="sticky top-0 z-20 bg-white shadow px-5 lg:px-24 py-3 flex justify-between items-center">
				...
				<div className="flex items-center gap-3 lg:gap-5">
					...
					<div className="relative cursor-pointer">
						...
						<IoCart size={26} className="text-black" />
					</div>
					...
					{user ? (
						...
						<Link
							to="/signin"
							className="cursor-pointer bg-gradient-to-r from-black to-gray-500 px-4 py-1.5 rounded-md text-white font-bold shadow-md hover:from-gray-500 hover:to-black transition text-sm md:text-base md:px-6 md:py-2"
						>
							Login
						</Link>
					)}
